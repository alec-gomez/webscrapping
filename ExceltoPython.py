...
#shows the amount of rows and columns in the excel sheet 
print(sheet1.max_row)
print(sheet1.max_column) 

for i in range (1,sheet1.max_row+1):  #add the plus one to get the last row "strawberries" 
...
#these two for loops do same thing. First one speifices rows second one gets them all 
